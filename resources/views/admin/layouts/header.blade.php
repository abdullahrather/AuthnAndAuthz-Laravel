        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('auth/assets/img/profile-img.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="" class="nav-link">{{ Auth::user()->email }}
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" class="nav-link">{{ Auth::user()->user_role->role }}
                                    </a>
                                </li>
                                <li class="nav-item">
